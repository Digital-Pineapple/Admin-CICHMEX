...
const style2 = {
  background:' linear-gradient(135deg,rgb(14, 32, 13) 0%,rgb(58, 138, 69) 43%,rgb(14, 36, 20) 100%)',
  borderRadius: '17px',
  width: '100%',
  height: '100%',
  color:'#fff',
...
export default function ModalDicountDetail({open, handleClose, data}) {
    ...
    const DISCOUNT_TYPES = [
      ...
      &::before {
        content: "${percent ? `${percent} % de descuento` : fixed_amount? `$${fixed_amount} de descuento`:`Envio Gratis`}";
        position: absolute;
        width: 150%;
        height: 50px;
