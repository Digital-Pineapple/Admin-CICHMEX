...
function BreadcrumbCustom({ paths = [] }) {
  return (
    <Breadcrumbs sx={{fontSize:{xs:"12px", lg:"14px"}, marginY:{xs:0, lg:2}}} separator={<ArrowRight color="secondary"/>} aria-label="breadcrumb">
      ...
      {paths.map((value, index) => {
        ...
        return last ? (
          <Typography  sx={{fontSize:{xs:"12px", lg:"14px"}, color: "success.main"}} key={to} >
