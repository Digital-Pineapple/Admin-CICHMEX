...
// Carga la lista de autos del cliente por su ID
...
// Obtiene la información de un auto específico por su ID
...
// Agrega un nuevo auto asociado a un cliente
...
// Edita la información de un auto existente por su ID
export const editOneMyCar = (id, values) => {
  return async (dispatch) => {
    try {
      ...
      console.log(error);
      enqueueSnackbar(`Ocurrió un error al actualizar el servicio : ${error}`,
      {variant:'error', anchorOrigin: {
        vertical: 'top',
        horizontal: 'right'
      }})
