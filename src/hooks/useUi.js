...
import { startChangeActive, startCreateOneBanner, startDeleteBanner, startLoadAllBanners, startLoadOneBanner  } from '../store/actions/uiActions'; 
...
export const useUI = () => {
    ...
    return { loading, banners, banner, loadAllBanners, navigate, loadOneBanner, createOneBanner, changeActiveBanner, deleteOneBanner }
